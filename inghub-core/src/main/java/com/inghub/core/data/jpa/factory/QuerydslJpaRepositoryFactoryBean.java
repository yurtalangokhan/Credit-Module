package com.inghub.core.data.jpa.factory;

import com.inghub.core.data.jpa.repository.ExtendedQuerydslPredicateExecutor;
import com.inghub.core.data.jpa.repository.JpaRepositoryImpl;
...
public class QuerydslJpaRepositoryFactoryBean<R extends JpaRepository<BE, ID>, BE, ID extends Serializable>
        extends JpaRepositoryFactoryBean<R, BE, ID> {
    ...
    private static class QuerydslJpaRepositoryFactory extends JpaRepositoryFactory {
        ...
        protected JpaRepositoryImplementation<?, ?> getTargetRepository(RepositoryInformation information, @NonNull EntityManager entityManager) {
            if (isQueryDslRepository(information)) {
                return new JpaRepositoryImpl(getEntityInformation(information.getDomainType()), entityManager);
            }
